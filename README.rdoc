...
For implementation I've created model class SalesItem which is mappedd to table sales_iems.
...
It has static set of functions and will be same for all sales_item_types. There is no need to create instances of it. I've created a module TaxCalculator which has all the functionality to calculate tax.
